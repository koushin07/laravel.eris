...
<template>
    <MunicipalityLayout v-if="$page.props.auth.user.role.role_type === 'RDRRMC_MUNICIPALITY'">

        <Head title="Setup Account" />
        <!-- <div class="box-border bg-white h-full md:col-span-3 rounded-xl">
            <div class="grid grid-flow-row lg:grid-cols-2 h-full ">
                <div class="box-border flex flex-row sidepic">
    ...
    <ProvinceLayout v-if="$page.props.auth.user.role.role_type === 'RDRRMC_PROVINCE'">
