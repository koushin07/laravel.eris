    ...
    <table class="table-auto  w-full text-sm  text-gray-500 dark:text-gray-400 border-2 border-orange-200">
        ...
        <tbody>
            <tr class="max-h-full  bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                v-for="(report, key) in reports.data" :key="key">
                <td scope="row"
                ...
                <td class="text-center">
                    <a :href="route('rdrrmc.report.show', report.id)" target="_blank" type="button"
                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                    Open

                    </a>
                    /
                    <a type="button" :href="'/rdrrmc/report/download/' + report.id"
                        class="cursor-pointer font-medium text-blue-600 dark:text-blue-500 hover:underline">Download</a>
