    ...
    <div class="flex flex-col mx-10 mt-4 gap-10">
        ...
        <div class="flex flex-col w-full">
            ...
            <div class="flex flex-row space-x-6 h-[250px]  md:h-[300px]">
                ...
                <div
                    class=" py-2 flex flex-col w-full content-box px-4  rounded-xl bg-white shadow-5 mt-4 ">
                    ...
                    <ul class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <li class="pb-3 sm:pb-4" v-for="(critacal, key) in criticals">
                            <div class="flex items-center space-x-4" v-if="critacal">
                                ...
                                <div
                                    class="flex flex-col min-w-0 justify-end ">
                                    <p class="text-sm font-medium text-gray-500 truncate dark:text-white">
                                        Remainings
                                    </p>
            ...
            <div class="flex flex-row justify-between ">
                ...
                <div class="flex flex-row space-x-3">
                    ...
                    <!-- <Dropdown align="left">
                     ...
                     font-semibold rounded text-sm px-2 py-2
                      dark:bg-orange-800 dark:text-orange-400 dark:border-orange-600 dark:hover:bg-orange-700 dark:hover:border-orange-600
                       dark:focus:ring-orange-700" type="button">
                ...
                <Table>
                    ...
                    <template #body>
                        <tr class="max-h-full even:bg-orange-200  bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                            ...
                            <td class="text-center">
                                <inertia-link type="button" :href="('/inventory/' + body.id)"
