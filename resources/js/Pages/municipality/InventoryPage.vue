    ...
    <ContentBox>
        <div class="flex flex-col space-y-5">
            <div class="grid grid-cols-4 place-content-between">
                ...
                <span class=" text-lg font-bold col-span-2 md:col-span-3">My Inventory</span>

                <div class="relative col-span-2 md:col-span-1">
                    <input type="search" id="search-dropdown" class="block  w-full z-20 text-sm border-2 bg-transparent rounded-lg focus:outline-none focus:ring-0  py-2 px-1
